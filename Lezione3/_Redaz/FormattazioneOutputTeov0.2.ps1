...
# v0.2 -nello script sono presenti più variabili in modo da renderlo più generalizzato,
#       è stata aggiunta ora e minuti nel nome del file in modo da non far sovrascrivere il file
#
...
$DatadiOggi = Get-Date -Format "ddMMyyyy_HHmm"
