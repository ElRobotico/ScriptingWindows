...
Get-Process | Select-Object -First 20 | Sort-Object ID -Descending | Export-Csv -Path "$path\$DatadiOggi`_Process.csv"
# tramite get-process si estraggono tutti processi in esecuzione, Select-object seleziona i primi 20 processi, sort-object li ordina in base all'ID in ordine decrescente, export-csv esporta il file nella cartella scelta a piacere 